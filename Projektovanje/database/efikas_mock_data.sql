...
-- USERS
INSERT INTO "efikas"."app_user" ("Name", "Surname", "JIB", "PasswordHash", "Email", "Address") VALUES
...
-- APARTMENTS
INSERT INTO "efikas"."apartment" ("Name", "Address", "NumberOfBeds", "NumberOfRooms", "Capacity", "PricePerDay", "PricePerNight", "UserId") VALUES
    ('Apartman srece 1', 'Ulica Kneza Milosa 10, Beograd', 2, 1, 3, 60.0, 45.0, 1),
    ('Apartman srece 2', 'Njegoseva 45, Novi Sad', 3, 2, 4, 75.0, 55.0, 2),
    ('Apartman srece 3', 'Kralja Petra 8, Banja Luka', 4, 3, 5, 90.0, 70.0, 3);
...
INSERT INTO efikas."guests_book" (
    ...
    "AccommodationUnitNumber", "AccommodationUnitFloor", "DateTimeOfArrival", "DateTimeOfDeparture",
...
INSERT INTO "efikas"."reservation" (
    ...
    (1, 1, 2, 120.0, 'Rezervisano online.', 1),
    (2, 2, 3, 150.0, 'Pozivom zakazano.', 2),
    (3, 3, 4, 270.0, 'Direktna rezervacija.', 2);

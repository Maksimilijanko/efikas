                    ...
                    <View style={styles.statusGroup}>
                        {(
                            <View style={[styles.statusLine, { marginTop: 10 }]}>
                                <Label text={t("apartment.card.status.current")} color={Colors.textSecondary} />
                                <Label text={statusText} color={statusColor} />
                                {status && statusUntil && (
                                    <View style={styles.statusLine}>
                                        <Label text={t("apartment.card.status.until")} color={Colors.textSecondary} />
                        ...
                        {showNextGuests && (
                            <View style={[styles.statusLine, { marginTop: 4 }]}>
                                <Label text={t("apartment.card.status.nextGuests")} color={Colors.textSecondary} />
